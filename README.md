...
- Clone and rename folder $ git clone git@github.com:dented-academy/next-starter.git kc-project-4
- Find and rename all instance of kc-project-4 to your actual project name
...
- Add to `.env.development.local` file (create if not exist)
  ...
  DATABASE_URL="postgresql://[user]:[password]@localhost:5432/kc-project-4"
  ```
